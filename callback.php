...
if ($ResultCode == 0) {
  ...
  mysqli_query($db, "INSERT INTO transactions (MerchantRequestID,CheckoutRequestID,ResultCode,ResultDesc) VALUES ('$MerchantRequestID','$CheckoutRequestID','$ResultCode','$ResultDesc')");
